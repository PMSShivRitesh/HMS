...
<div class="span3 bs-docs-sidebar">
	<ul class="nav nav-list bs-docs-sidenav" id="idmenus">
		...
		<li id="1"><a href="operatordashboard.html"><i class="icon-home"></i>
		<i class="icon-chevron-right"></i>Home</a></li>
		
		 <li id="1"><a href="registerpatient.html"><i class="icon-pencil"></i>
		<i class="icon-chevron-right"></i>Register Patient</a></li>
